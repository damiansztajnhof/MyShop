...
using MyShop.NetUI.Controllers;
using MyShop.NetUI.Tests.Mocks;
using MyShop.Services;

namespace MyShop.NetUI.Tests.Controllers
{
    [TestClass]
    public class BasketControllerTest
    {
        ...
        public void canCheckoutAndCreateOrder()
        {
            ...
            IRepository<Order> orders = new MockContext<Order>();
            IOrderService orderService = new OrderService(orders);
            customers.Insert(new Customer() { Id = "1", Email = "kocurass@gmail.com", ZipCode = "43443" });
            IPrincipal FakeUser = new GenericPrincipal(new GenericIdentity("kocurass@gmail.com", "Forms"),null);
            var controller = new BasketController(basketService, orderService,customers);
            var httpContext = new MockHttpContext();
